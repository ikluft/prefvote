...
is($stv_tally_ref->tally(), 0, "default: tally = 0");
...
$stv_tally_ref->mark_as_winner(place => 1, tally => 42, surplus => 12, transfer => 10);
is($stv_tally_ref->winner(), 1, "winner: check winner = 1");
is($stv_tally_ref->place(), 1, "winner: check place = 1");
is($stv_tally_ref->tally(), 42, "winner: check tally = 42");
...
is($stv_tally_ref2->tally(), 0, "eliminated: check tally = 0");
