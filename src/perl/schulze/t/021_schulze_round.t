...
lives_ok(sub {$schulze_round_ref2 = PrefVote::Schulze::Round->new(number => 1,
    candidates => Readonly::Clone @candidate_names)}, "instantiate with candidates -> no exception");
lives_ok(sub {$schulze_round_ref2->init_round_candidates()}, "init_round_candidates() with candidates -> no exception");
...
is($schulze_round_ref->add_preference("ABNORMAL", "FACTIOUS", 1), 1,
    "add_preference(ABNORMAL,FACTIOUS, 1) returns 1");
...
is($schulze_round_ref->{pair}{ABNORMAL}{FACTIOUS}->preference(), 1,
    "pair{ABNORMAL}{FACTIOUS}->preference is 1");
is($schulze_round_ref->get_preference("ABNORMAL", "FACTIOUS"), 1, "get_preference(ABNORMAL,FACTIOUS) returns 1");
is($schulze_round_ref->add_preference("ABNORMAL", "FACTIOUS", 2), 3,
    "add_preference(ABNORMAL,FACTIOUS, 2) returns 3");
...
is($schulze_round_ref->get_predecessor("ABNORMAL", "FACTIOUS"), "ABNORMAL",
    "default get_predecessor(ABNORMAL,FACTIOUS) returns ABNORMAL");
is($schulze_round_ref->{pair}{ABNORMAL}{FACTIOUS}->predecessor(), "ABNORMAL",
    "pair{ABNORMAL}{FACTIOUS}->predecessor is ABNORMAL");
is($schulze_round_ref->set_predecessor("ABNORMAL", "FACTIOUS", "CHAOTIC"), "CHAOTIC",
    "set_predecessor(ABNORMAL,FACTIOUS,CHAOTIC) returns CHAOTIC");
is($schulze_round_ref->get_predecessor("ABNORMAL", "FACTIOUS"), "CHAOTIC",
    "get_predecessor(ABNORMAL,FACTIOUS) returns CHAOTIC");

# check strength (3 tests)
is($schulze_round_ref->set_strength("ABNORMAL", "FACTIOUS", 10), 10, "set_strength(ABNORMAL,FACTIOUS, 10) returns 10");
is($schulze_round_ref->get_strength("ABNORMAL", "FACTIOUS"), 10, "get_strength(ABNORMAL,FACTIOUS) returns 10");
is($schulze_round_ref->{pair}{ABNORMAL}{FACTIOUS}->strength(), 10,
    "pair{ABNORMAL}{FACTIOUS}->strength is 10");

# check win_order (6 tests)
is($schulze_round_ref->set_win_order("ABNORMAL", "FACTIOUS", 0), 0, "set_win_order(ABNORMAL,FACTIOUS, 0) returns 0");
is($schulze_round_ref->get_win_order("ABNORMAL", "FACTIOUS"), 0, "get_win_order(ABNORMAL,FACTIOUS) returns 0");
is($schulze_round_ref->{pair}{ABNORMAL}{FACTIOUS}->win_order(), 0,
    "pair{ABNORMAL}{FACTIOUS}->win_order is 0");
is($schulze_round_ref->set_win_order("ABNORMAL", "FACTIOUS", 1), 1, "set_win_order(ABNORMAL,FACTIOUS, 1) returns 1");
is($schulze_round_ref->get_win_order("ABNORMAL", "FACTIOUS"), 1, "get_win_order(ABNORMAL,FACTIOUS) returns 1");
is($schulze_round_ref->{pair}{ABNORMAL}{FACTIOUS}->win_order(), 1,
    "pair{ABNORMAL}{FACTIOUS}->win_order is 1");
