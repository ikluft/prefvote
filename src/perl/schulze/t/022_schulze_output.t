...
Readonly::Array my @result_expected => (
    ...
    },
    {
        'rows' => [
            ...
            [ 'EVIL',     "\x{1f6c7}",    "1 \x{2705}", "12 \x{2705}", "7 \x{2705}",  "17 \x{2705}", "14 \x{2705}" ],
            [ 'FACTIOUS', "-1 \x{274c}",  "\x{1f6c7}",  "12 \x{2705}", "10 \x{2705}", "13 \x{2705}", "11 \x{2705}" ],
            [ 'CHAOTIC',  "-12 \x{274c}", "-12 \x{274c}", "\x{1f6c7}",   "2 \x{2705}",  "2 \x{2705}",  "15 \x{2705}" ],
            [ 'BORING',   "-7 \x{274c}",  "-10 \x{274c}", "-2 \x{274c}", "\x{1f6c7}",   "0 \x{1f535}", "6 \x{2705}" ],
            [ 'ABNORMAL', "-17 \x{274c}", "-13 \x{274c}", "-2 \x{274c}", "0 \x{1f535}", "\x{1f6c7}",   "1 \x{2705}" ],
            [
                'DYSFUNCTIONAL',
                "-14 \x{274c}",
                "-11 \x{274c}",
